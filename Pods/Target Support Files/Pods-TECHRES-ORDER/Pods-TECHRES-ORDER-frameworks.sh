...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JNSegmentedControl/JNSegmentedControl.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QRealmManager/QRealmManager.framework"
