...
class PravicyPolicyViewController: BaseViewController {
    var viewModel = PraricyPolicyViewModel()
    var router = PraricyPolicyRouter()
    
    @IBOutlet weak var view_webview: UIView!
    
    var urlWebsite = "https://techres.vn/chinh-sach-bao-mat/"
