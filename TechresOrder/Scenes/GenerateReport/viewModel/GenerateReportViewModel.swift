...
class GenerateReportViewModel: BaseViewModel {
    ...
    public var dailyOrderReport = BehaviorRelay<DailyOrderReport>(value: DailyOrderReport.init(reportType: REPORT_TYPE_TODAY, dateString: Utils.getCurrentDateTime().dateTimeNow))
   
    public var toDayRenueReport = BehaviorRelay<RevenueReport>(value: RevenueReport.init(reportType: REPORT_TYPE_TODAY, dateString: Utils.getCurrentDateTime().dateTimeNow))
    
    public var saleReport = BehaviorRelay<SaleReport>(value: SaleReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
        
    public var revenueCostProfitReport = BehaviorRelay<RevenueFeeProfitReport>(value: RevenueFeeProfitReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))

    public var areaRevenueReport = BehaviorRelay<AreaRevenueReport>(value: AreaRevenueReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var tableRevenueReport = BehaviorRelay<TableRevenueReport>(value:TableRevenueReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var employeeRevenueReport = BehaviorRelay<EmployeeRevenueReport>(value: EmployeeRevenueReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var foodReport = BehaviorRelay<FoodReportData>(value: FoodReportData.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var commodityReport = BehaviorRelay<FoodReportData>(value: FoodReportData.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var categoryRevenueReport = BehaviorRelay<RevenueCategoryReport>(value: RevenueCategoryReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var giftedFoodReport = BehaviorRelay<FoodReportData>(value: FoodReportData.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var otherFoodReport = BehaviorRelay<FoodReportData>(value: FoodReportData.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var cancelFoodReport = BehaviorRelay<FoodReportData>(value: FoodReportData.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var takeAwayFoodReport = BehaviorRelay<FoodReportData>(value: FoodReportData.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var vatReport = BehaviorRelay<VATReport>(value: VATReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var discountReport = BehaviorRelay<DiscountReport>(value: DiscountReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
    
    public var surchargeReport = BehaviorRelay<SurchargeReport>(value: SurchargeReport.init(reportType: REPORT_TYPE_THIS_MONTH, dateString: Utils.getCurrentDateTime().thisMonth))
...
extension GenerateReportViewModel {
    ...
    func getReportRevenueGenral() -> Observable<APIResponse> {
        return appServiceProvider.rx.request(.getReportRevenueGenral(restaurant_brand_id: restaurant_brand_id.value, branch_id: branch_id.value, report_type: saleReport.value.reportType, date_string: saleReport.value.dateString, from_date: from_date.value, to_date: to_date.value))
               .filterSuccessfulStatusCodes()
               .mapJSON().asObservable()
               .showAPIErrorToast()
               .mapObject(type: APIResponse.self)
