//
//  ReportDiscountTableViewCell+Extension+Chart+Proccess.swift
//  Techres-Seemt
//
//  Created by Kelvin on 12/05/2023.
...
extension ReportDiscountTableViewCell{
    ...
    private class CustomMarkerView: MarkerView {
        ...
        private let dataChart: [DiscountReportData]

        init(frame: CGRect, dataChart: [DiscountReportData]) {
        ...
        override func refreshContent(entry: ChartDataEntry, highlight: Highlight) {
            ...
            let quantity = dataChart[index].order_quantity
