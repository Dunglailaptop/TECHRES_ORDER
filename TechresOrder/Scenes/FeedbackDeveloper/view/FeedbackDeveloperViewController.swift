...
//            strongSelf.view_btn_sent_background.backgroundColor = isValid ? ColorUtils.buttonOrangeColor() :ColorUtils.buttonGrayColor()
//
////            strongSelf.lbl_sent_background.textColor = isValid ? ColorUtils.white() : ColorUtils.w()
//
//
//        })
