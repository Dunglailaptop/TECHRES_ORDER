...
extension UpdateBranchViewController {
    ...
    func setupProfile(){
        ...
        if typecheck == 0 {
            image_Logo.kf.setImage(with: URL(string: Utils.getFullMediaLink(string: viewModel.dataArray.value.image_logo)), placeholder:  UIImage(named: "image_defauft_medium"))
